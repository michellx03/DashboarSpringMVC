...
<div class="btn-group">
						<a href="/DashboardSpringMVC/Produto/Cadastro"
								...
								<td class="hidden-xs">
									<div class="btn-group pull-right">
										...
										<li><a download="download"
											...
											<li><a
												href="/DashboardSpringMVC/Produto/Editar?id=<%out.print(obj[0]);%>">
													<i class="fa fa-edit"></i> Alterar
											</a></li>
											<li><a
												href="/DashboardSpringMVC/Produto/Excluir?id=<%out.print(obj[0]);%>">
