		...
		<div class="col-md-12">
			...
			<div class="portlet light bordered">
				<div class="portlet-title">
					...
					%>
					<div class="btn-group">
						<a href="/DashboardSpringMVC/Usuario/Cadastro"
								...
								<td class="hidden-xs">
									<div class="btn-group pull-right">
										...
										<ul class="dropdown-menu pull-right">
											<li><a
												href="/DashboardSpringMVC/Usuario/Alteracao?id=<%out.print(obj[0]);%>">
													<i class="fa fa-edit"></i> Alterar
											</a></li>
											<li><a
												href="/DashboardSpringMVC/Usuario/Excluir?id=<%out.print(obj[0]);%>">
